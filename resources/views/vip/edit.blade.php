    ...
    <div class="video-submit-container">
        <div class="video-submit-wrapper">
            ...
            <div class="form-wrapper">
                <form action="{{ route('vip.update', $video->id) }}" method="POST">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}

                    <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                        <label for="name">标题</label>
                        <input name="name" class="form-control" value="{{ $video->name }}" placeholder="标题" id="name" required="required">
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group {{ $errors->has('rank') ? 'has-error' : ''}}">
                        ...
                        <input type="number" name="rank" class="form-control" value="{{ $video->rank }}" placeholder="1, 2, 3" id="rank" required="required">
                        @if ($errors->has('rank'))
                            <span class="help-block">
                    ...
                    <div class="form-group {{ $errors->has('duration') ? 'has-error' : ''}}">
                        ...
                        <input name="duration" class="form-control" value="{{ $video->duration }}" placeholder="02:12" id="duration" required="required">
                    ...
                    <div class="form-group {{ $errors->has('price') ? 'has-error' : ''}}">
                        ...
                        <input type="number" name="price" class="form-control" value="{{ $video->price }}" placeholder="价格" id="price" required="required">
                        @if ($errors->has('price'))
                            <span class="help-block">
                    ...
                    <div class="form-group {{ $errors->has('tb_link') ? 'has-error' : ''}}">
                        ...
                        <input name="tb_link" class="form-control" value="{{ $video->tb_link }}" placeholder="淘宝链接" id="tb_link" required="required">
                    ...
                    <div class="form-group {{ $errors->has('download') ? 'has-error' : ''}}">
                        ...
                        <input name="download" class="form-control" value="{{ $video->download_link }}" placeholder="下载链接" id="download" required="required">
                    ...
                    <div class="form-group {{ $errors->has('netdisk_key') ? 'has-error' : ''}}">
                        ...
                        <input name="netdisk_key" class="form-control" value="{{ $video->netdisk_key }}" placeholder="可空" id="netdisk_key">
